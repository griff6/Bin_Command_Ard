...
int16_t DallasTemperature::getMois(const uint8_t* deviceAddress){
    ...
    if (deviceAddress[0] == DS28EA00MODEL){
        ...
        _wire->reset();
        _wire->select(deviceAddress);
        _wire->write(0xA5, parasite);           //write access
        _wire->write(0x01, parasite);           //output 0000 0001 (Put PIOA HIgh, PIOB Low)
        _wire->write(0xFE, parasite);           //output 1111 1110 (CRC)
        _wire->read();
        _wire->read();
        _wire->write(0x03, parasite);           //Output 0000 0011 (Put PIOA HIgh, PIOB High)
        _wire->write(0xFC, parasite);           //output 1111 1100 (CRC)
        _wire->read();
        _wire->read();
        _wire->write(0x02, parasite);           //0000 0010 (PIOA Low, PIOB High)
        _wire->write(0xFD, parasite);           //CRC
        _wire->read();
        _wire->read();
        _wire->write(0xF0, parasite);           //1111 0000 (PIOA Low, PIOB Low)
        _wire->write(0x0F, parasite);           //CRC
        _wire->read();
        _wire->read();
        _wire->write(0x02, parasite);           //PIOA Low, PIOB HIgh
        _wire->write(0xFD, parasite);           //CRC
        _wire->read();
        _wire->read();
        _wire->write(0x03, parasite);           //Put PIOA HIgh, PIOB High
        _wire->write(0xFC, parasite);
        _wire->read();
        _wire->read();
        _wire->write(0x01, parasite);           // PIOA High, PIOB Low
        _wire->write(0xFE, parasite);
        _wire->read();
        _wire->read();
        _wire->write(0xF0, parasite);           //PIOA Low, PIOB Low
        ...
        _wire->read();
        _wire->read();
        _wire->write(0xF0, parasite);           //Low, Low
        _wire->write(0x0F, parasite);
        _wire->read();
        _wire->read();
        _wire->write(0x02, parasite);           //Low, High
        ...
        _wire->read();
        _wire->read();
        _wire->write(0x01, parasite);           //High, Low
        _wire->write(0xFE, parasite);
        _wire->read();
        _wire->read();
        _wire->write(0x03, parasite);           //High, High
        _wire->write(0xFC, parasite);
        _wire->read();
        _wire->read();
        _wire->write(0x01, parasite);           //High, Low
        ...
        _wire->read();
        _wire->read();
        _wire->write(0xF0, parasite);           //High High
        _wire->write(0x0F, parasite);
        _wire->read();
        _wire->read();
        _wire->write(0x01, parasite);           //High, Low
